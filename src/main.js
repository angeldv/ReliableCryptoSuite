// src/main.js
/**
 * Main entry point for ReliableCryptoSuite application
 */
...
class ReliableCryptoSuite {
    /**
     * Create a new ReliableCryptoSuite instance
...
module.exports = ReliableCryptoSuite;
...
if (require.main === module) {
    ...
    const app = new ReliableCryptoSuite({
        input: args.input,
        output: args.output,
